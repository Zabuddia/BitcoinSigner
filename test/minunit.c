...
static char* test_Signature_der() {
    ...
    printf("Signature size: %d\n", Signature_der_length(signature));
...
static char* test_print_formatted_bytes() {
    const unsigned char* hex_string = (const unsigned char*)"";
...
static char* test_find_differences() {
    const char* s1 = "01000000022f2afe57bde0822c793604baae834f2cd26155bf1c0d37480212c107e75cd0110100000000ffffffff153db0202de27e7944c7fd651ec1d0fab1f1aaed4b0da60d9a1b06bd771ff651010000001976a914d52ad7ca9b3d096a38e752c2018e6fbc40cdf26f88acffffffff";
    const char* s2 = "01000000022f2afe57bde0822c793604baae834f2cd26155bf1c0d37480212c107e75cd0110100000000ffffffff153db0202de27e7944c7fd651ec1d0fab1f1aaed4b0da60d9a1b06bd771ff651010000001976a914d52ad7ca9b3d096a38e752c2018e6fbc40cdf26f88acffffffff";
...
static char* test_create_transaction() {
    ...
    unsigned char tx_in_1_serialized[TxIn_length(tx_in_1)];
    TxIn_serialize(tx_in_1, tx_in_1_serialized);
    printf("TxIn 1: ");
    for (int i = 0; i < TxIn_length(tx_in_1); i++) {
        printf("%02x", tx_in_1_serialized[i]);
    }
    printf("\n");
    Script* script_sig_2 = script_init();
    TxIn* tx_in_2 = TxIn_init(prev_tx_2, prev_index_2, script_sig_2, 0xffffffff);
    unsigned char tx_in_2_serialized[TxIn_length(tx_in_2)];
    TxIn_serialize(tx_in_2, tx_in_2_serialized);
    printf("TxIn 2: ");
    for (int i = 0; i < TxIn_length(tx_in_2); i++) {
        printf("%02x", tx_in_2_serialized[i]);
    }
    printf("\n");
    ...
    unsigned char tx_out_1_serialized[TxOut_length(target_tx_out_1)];
    TxOut_serialize(target_tx_out_1, tx_out_1_serialized);
    printf("TxOut 1: ");
    for (int i = 0; i < TxOut_length(target_tx_out_1); i++) {
        printf("%02x", tx_out_1_serialized[i]);
    }
    printf("\n");
    TxIn* inputs_1[2] = {tx_in_1, tx_in_2};
    TxOut* outputs_1[1] = {target_tx_out_1};
    Tx* tx_1 = Tx_init(1, 2, inputs_1, 1, outputs_1, 0, TRUE);
    unsigned char tx_serialized_1[126] = {0};
    Tx_serialize(tx_1, tx_serialized_1);
    printf("Tx 1: ");
    for (int i = 0; i < 126; i++) {
        printf("%02x", tx_serialized_1[i]);
    }
    printf("\n");
    size_t result_1 = sign_input(tx_1, 0, private_key_1);
    unsigned char tx_serialized_2[232] = {0};
    Tx_serialize(tx_1, tx_serialized_2);
    printf("Tx 2: ");
    for (int i = 0; i < 232; i++) {
        printf("%02x", tx_serialized_2[i]);
    }
    printf("\n");
