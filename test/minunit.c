...
static char* test_Deterministic_k() {
    ...
    // hash_to_mpz_t((const unsigned char*)"test secret", 11, secret);
    PrivateKey* test_key = PrivateKey_init(secret);
    S256Field* test_k = Deterministic_k(test_key, test_z);
    mpz_t expected_k;
    mpz_init_set_str(expected_k, "1119FF7EEBE4E7AE6C6FF4FFA20852152C76D9ABDBEECEF6CD6AE3E08BD6A520", 16);
...
static char* test_PrivateKey_sign() {
    ...
    mpz_t expected_r;
    mpz_init_set_str(expected_r, "C07F2D82B71B02D25824B7207D8519828CC2C5280FD032E8925171F5AAFE4B8B", 16);
    mpz_t expected_s;
    mpz_init_set_str(expected_s, "3A5A4B502150A3B40E12DB9B060AA5A9EFB52D846E04A0A7E406EEF26F39F04A", 16);
...
static char* test_print_formatted_bytes() {
    const unsigned char* hex_string = (const unsigned char*)"";
    print_formatted_bytes(hex_string);
    const unsigned char* hex_string_2 = (const unsigned char*)"03b287eaf122eea69030a0e9feed096bed8045c8b98bec453e1ffac7fbdbd4bb71";
    print_formatted_bytes(hex_string_2);
    const unsigned char* hex_string3 = (const unsigned char*)"3045022100da6bee3c93766232079a01639d07fa869598749729ae323eab8eef53577d611b02207bef15429dcadce2121ea07f233115c6f09034c0be68db99980b9a6c5e754022";
    print_formatted_bytes(hex_string3);
    const unsigned char* hex_string_4 = (const unsigned char*)"475221022626e955ea6ea6d98850c994f9107b036b1334f18ca8830bfff1295d21cfdb702103b287eaf122eea69030a0e9feed096bed8045c8b98bec453e1ffac7fbdbd4bb7152ae";
...
static char* test_script_add() {
    ...
    unsigned char script_sig_2[108] = {0x6b, 0x48, 0x30, 0x45, 0x02, 0x21, 0x00, 0xed, 0x81, 0xff, 0x19, 0x2e, 0x75, 0xa3, 0xfd, 0x23, 0x04, 0x00, 0x4d, 0xca, 0xdb, 0x74, 0x6f, 0xa5, 0xe2, 0x4c, 0x50, 0x31, 0xcc, 0xfc, 0xf2, 0x13, 0x20, 0xb0, 0x27, 0x74, 0x57, 0xc9, 0x8f, 0x02, 0x20, 0x7a, 0x98, 0x6d, 0x95, 0x5c, 0x6e, 0x0c, 0xb3, 0x5d, 0x44, 0x6a, 0x89, 0xd3, 0xf5, 0x61, 0x00, 0xf4, 0xd7, 0xf6, 0x78, 0x01, 0xc3, 0x19, 0x67, 0x74, 0x3a, 0x9c, 0x8e, 0x10, 0x61, 0x5b, 0xed, 0x01, 0x21, 0x03, 0x49, 0xfc, 0x4e, 0x63, 0x1e, 0x36, 0x24, 0xa5, 0x45, 0xde, 0x3f, 0x89, 0xf5, 0xd8, 0x68, 0x4c, 0x7b, 0x81, 0x38, 0xbd, 0x94, 0xbd, 0xd5, 0x31, 0xd2, 0xe2, 0x13, 0xbf, 0x01, 0x6b, 0x27, 0x8a};
    unsigned char script_pubkey_2[26] = {0x19, 0x76, 0xa9, 0x14, 0xa8, 0x02, 0xfc, 0x56, 0xc7, 0x04, 0xce, 0x87, 0xc4, 0x2d, 0x7c, 0x92, 0xeb, 0x75, 0xe7, 0x89, 0x6b, 0xdc, 0x41, 0xae, 0x88, 0xac};
...
static char* test_verify_p2sh() {
    unsigned char raw_tx[32] = {0x46, 0xdf, 0x1a, 0x94, 0x84, 0xd0, 0xa8, 0x1d, 0x03, 0xce, 0x0e, 0xe5, 0x43, 0xab, 0x6e, 0x1a, 0x23, 0xed, 0x06, 0x17, 0x5c, 0x10, 0x4a, 0x17, 0x82, 0x68, 0xfa, 0xd3, 0x81, 0x21, 0x6c, 0x2b};
    Tx* tx = fetch(raw_tx, FALSE);
...
static char* test_decode_base58() {
    unsigned char* string = (unsigned char*)"mnrVtF8DWjMu839VW3rBfgYaAfKk8983Xf";
    unsigned char result[20] = {0};
    decode_base58(string, 34, result);
    unsigned char expected_result[25] = {0x50, 0x7b, 0x27, 0x41, 0x1c, 0xcf, 0x7f, 0x16, 0xf1, 0x02, 0x97, 0xde, 0x6c, 0xef, 0x3f, 0x29, 0x16, 0x23, 0xed, 0xdf};
    mu_assert("Error: decode_base58 doesn't work", memcmp(result, expected_result, 20) == 0);
    return 0;
}

static char* test_p2pkh_script() {
    unsigned char prev_tx[32] = {0x0d, 0x6f, 0xe5, 0x21, 0x3c, 0x0b, 0x32, 0x91, 0xf2, 0x08, 0xcb, 0xa8, 0xbf, 0xb5, 0x9b, 0x74, 0x76, 0xdf, 0xfa, 0xcc, 0x4e, 0x5c, 0xb6, 0x6f, 0x6e, 0xb2, 0x0a, 0x08, 0x08, 0x43, 0xa2, 0x99};
    int prev_index = 13;
    Script* script_sig = script_init();
    TxIn* tx_in = TxIn_init(prev_tx, prev_index, script_sig, 0xffffffff);
    unsigned long long change_amount = 33000000ULL;
    unsigned char change_h160[20] = {0};
    unsigned char* change_base58 = (unsigned char*)"mzx5YhAH9kNHtcN481u6WkjeHjYtVeKVh2";
    ...
    unsigned long long target_amount = 10000000ULL;
    unsigned char target_h160[20] = {0};
    unsigned char* target_base58 = (unsigned char*)"mnrVtF8DWjMu839VW3rBfgYaAfKk8983Xf";
    ...
    Tx* tx_obj = Tx_init(1, 1, inputs, 2, outputs, 0, TRUE);
    unsigned char tx_obj_expected[119] = {0x01, 0x00, 0x00, 0x00, 0x01, 0x99, 0xa2, 0x43, 0x08, 0x08, 0x0a, 0xb2, 0x6e, 0x6f, 0xb6, 0x5c, 0x4e, 0xcc, 0xfa, 0xdf, 0x76, 0x74, 0x9b, 0xb5, 0xbf, 0xa8, 0xcb, 0x08, 0xf2, 0x91, 0x32, 0x0b, 0x3c, 0x21, 0xe5, 0x6f, 0x0d, 0x0d, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x02, 0x40, 0x8a, 0xf7, 0x01, 0x00, 0x00, 0x00, 0x00, 0x19, 0x76, 0xa9, 0x14, 0xd5, 0x2a, 0xd7, 0xca, 0x9b, 0x3d, 0x09, 0x6a, 0x38, 0xe7, 0x52, 0xc2, 0x01, 0x8e, 0x6f, 0xbc, 0x40, 0xcd, 0xf2, 0x6f, 0x88, 0xac, 0x80, 0x96, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00, 0x19, 0x76, 0xa9, 0x14, 0x50, 0x7b, 0x27, 0x41, 0x1c, 0xcf, 0x7f, 0x16, 0xf1, 0x02, 0x97, 0xde, 0x6c, 0xef, 0x3f, 0x29, 0x16, 0x23, 0xed, 0xdf, 0x88, 0xac, 0x00, 0x00, 0x00, 0x00};
    unsigned char tx_obj_serialized[119] = {0};
    ...
    for (unsigned long long i = 0; i < tx_obj->num_inputs; i++) {
        TxIn_free(tx_obj->tx_ins[i]);
    }
    for (unsigned long long i = 0; i < tx_obj->num_outputs; i++) {
...
static char* test_create_transaction() {
    ...
    unsigned char prev_tx_1[32] = {0x11, 0xd0, 0x5c, 0xe7, 0x07, 0xc1, 0x12, 0x02, 0x48, 0x37, 0x0d, 0x1c, 0xbf, 0x55, 0x61, 0xd2, 0x2c, 0x4f, 0x83, 0xae, 0xba, 0x04, 0x36, 0x79, 0x2c, 0x82, 0xe0, 0xbd, 0x57, 0xfe, 0x2a, 0x2f};
    unsigned char prev_tx_2[32] = {0x51, 0xf6, 0x1f, 0x77, 0xbd, 0x06, 0x1b, 0x9a, 0x0d, 0xa6, 0x0d, 0x4b, 0xed, 0xaa, 0xf1, 0xb1, 0xfa, 0xd0, 0xc1, 0x1e, 0x65, 0xfd, 0xc7, 0x44, 0x79, 0x7e, 0xe2, 0x2d, 0x20, 0xb0, 0x3d, 0x15};
    int prev_index_1 = 1;
    int prev_index_2 = 1;
    unsigned char* target_address_1 = (unsigned char*)"mwJn1YPMq7y5F8J3LkC5Hxg9PHyZ5K4cFv";
    unsigned long long target_amount_1 = 4290000;
    mpz_t secret_1;
    ...
    unsigned char target_h160_1[20] = {0};
    ...
    Tx* tx_1 = Tx_init(1, 2, inputs_1, 1, outputs_1, 0, TRUE);
...
static char* test_verify_signature_from_transaction() {
    ...
    mpz_init_set_str(Z, z_hex, 16);
    S256Field* z = S256Field_init(Z);
    unsigned char sec[33] = {0x02, 0x26, 0x26, 0xe9, 0x55, 0xea, 0x6e, 0xa6, 0xd9, 0x88, 0x50, 0xc9, 0x94, 0xf9, 0x10, 0x7b, 0x03, 0x6b, 0x13, 0x34, 0xf1, 0x8c, 0xa8, 0x83, 0x0b, 0xff, 0xf1, 0x29, 0x5d, 0x21, 0xcf, 0xdb, 0x70};
    unsigned char der[71] = {0x30, 0x45, 0x02, 0x21, 0x00, 0xdc, 0x92, 0x65, 0x5f, 0xe3, 0x70, 0x36, 0xf4, 0x77, 0x56, 0xdb, 0x81, 0x02, 0xe0, 0xd7, 0xd5, 0xe2, 0x8b, 0x3b, 0xeb, 0x83, 0xa8, 0xfe, 0xf4, 0xf5, 0xdc, 0x05, 0x59, 0xbd, 0xdf, 0xb9, 0x4e, 0x02, 0x20, 0x5a, 0x36, 0xd4, 0xe4, 0xe6, 0xc7, 0xfc, 0xd1, 0x66, 0x58, 0xc5, 0x07, 0x83, 0xe0, 0x0c, 0x34, 0x16, 0x09, 0x97, 0x7a, 0xed, 0x3a, 0xd0, 0x09, 0x37, 0xbf, 0x4e, 0xe9, 0x42, 0xa8, 0x99, 0x37};
    ...
    unsigned char i_serialized[112] = {0};
    ...
    for (size_t i = 0; i < tx_obj->num_outputs; i++) {
        ...
        unsigned long long o_serialized_length = TxOut_length(o);
        unsigned char o_serialized[o_serialized_length];
